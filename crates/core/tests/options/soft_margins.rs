...
//! Fixtures live under tests/java/soft_margins/.

use super::common::*;
use java_formatter_core::config::WrapStyle;

const LONG_LINE: &str = include_str!("../java/soft_margins/long_line.java");
const LONG_LINE_OUT: &str = include_str!("../java/soft_margins/long_line.out.java");
const LONG_LINE_120_OUT: &str = include_str!("../java/soft_margins/long_line_120.out.java");
