//! DOWHILE_BRACE_FORCE — whether braces are forced around brace-less do /
//! while bodies.
//! Fixtures live under tests/java/dowhile_brace_force/.
//!
...
const BODIES: &str = include_str!("../java/dowhile_brace_force/dowhile_brace_force.java");
const BODIES_DEFAULT_OUT: &str =
    include_str!("../java/dowhile_brace_force/dowhile_brace_force_default.out.java");
const BODIES_CODE0_OUT: &str =
    include_str!("../java/dowhile_brace_force/dowhile_brace_force_code0.out.java");
const BODIES_CODE1_OUT: &str =
    include_str!("../java/dowhile_brace_force/dowhile_brace_force_code1.out.java");
const BODIES_CODE3_OUT: &str =
    include_str!("../java/dowhile_brace_force/dowhile_brace_force_code3.out.java");
const BRACED: &str = include_str!("../java/dowhile_brace_force/dowhile_brace_force_braced.java");
const BRACED_OUT: &str =
    include_str!("../java/dowhile_brace_force/dowhile_brace_force_braced.out.java");

fn force(f: ForceStyle) -> JavaStyle {
    style(|s| s.dowhile_brace_force = f)
}
